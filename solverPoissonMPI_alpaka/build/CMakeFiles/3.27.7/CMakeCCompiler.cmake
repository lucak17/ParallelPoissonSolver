...
set(CMAKE_C_IMPLICIT_LINK_LIBRARIES "amdhip64;sci_cray_mpi;mpi_cray;mpi_gtl_hsa;sci_cray;dl;dsmml;xpmem;stdc++;pgas-shmem;quadmath;modules;fi;craymath;f;u;csup;pthread;atomic;m;unwind;c;unwind")
set(CMAKE_C_IMPLICIT_LINK_DIRECTORIES "/opt/cray/pe/mpich/8.1.28/ofi/cray/17.0/lib;/opt/cray/pe/mpich/8.1.28/gtl/lib;/opt/cray/pe/libsci/23.12.5/CRAY/17.0/x86_64/lib;/opt/rocm-5.7.0/lib64;/opt/rocm-5.7.0/lib;/opt/rocm-5.7.0/rocprofiler/lib;/opt/rocm-5.7.0/rocprofiler/tool;/opt/rocm-5.7.0/roctracer/lib;/opt/rocm-5.7.0/roctracer/tool;/opt/rocm-5.7.0/hip/lib;/opt/cray/xpmem/2.8.2-1.0_3.9__g84a27a5.shasta/lib64;/opt/cray/pe/dsmml/0.2.2/dsmml/lib;/opt/cray/pe/cce/17.0.0/cce/x86_64/lib;/usr/lib64/gcc/x86_64-suse-linux/12;/usr/lib64;/lib64;/usr/x86_64-suse-linux/lib;/lib;/usr/lib;/opt/cray/pe/cce/17.0.0/cce-clang/x86_64/lib")
